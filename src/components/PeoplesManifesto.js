        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="space-y-8">
            ...
            <p className="text-white/90 text-base sm:text-lg leading-relaxed">
              আমরা বিশ্বাস করি, জনগণই সকল ক্ষমতার উৎস। তাই আমরা সরাসরি জনগণের কাছ থেকে 
              তাদের দাবি, প্রত্যাশা ও পরামর্শ সংগ্রহ করছি। আপনার মতামতই হবে আমাদের 
              নির্বাচনী ইস্তেহারের ভিত্তি।
            </p>
