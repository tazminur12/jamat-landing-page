      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center min-h-[80vh]">
          ...
          <div className="z-10 flex flex-col gap-6 lg:gap-8">
            ...
            {/* Main Headline */}
            <div className="my-4">
              <h1 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-black leading-tight flex flex-col gap-2">
                <span className="text-white">অধ্যক্ষ মাওলানা শাহাদাতুজ্জামান কে</span>
            ...
            <div className="flex flex-col sm:flex-row gap-4 mt-4">
              <Link 
                href="/manifesto" 
                className="inline-flex items-center justify-center gap-2 bg-white text-[#0a4040] px-5 sm:px-6 py-2.5 sm:py-3 rounded-full font-bold text-sm sm:text-base transition-all duration-300 hover:-translate-y-1 shadow-lg hover:shadow-xl">
              ...
              <Link 
                href="/" 
                className="inline-flex items-center justify-center gap-2 bg-green-500 text-white px-5 sm:px-6 py-2.5 sm:py-3 rounded-full font-bold text-sm sm:text-base transition-all duration-300 hover:-translate-y-1 hover:bg-green-600 shadow-lg hover:shadow-xl"
          ...
          <div className="relative flex justify-center items-center lg:justify-end">
            <div className="relative w-full max-w-md lg:max-w-lg xl:max-w-xl">
              <Image
                src="/candidate/shahtudjaman.jpg"
                alt="অধ্যক্ষ শাহাদাতুজ্জামান"
                width={600}
                height={700}
                priority
