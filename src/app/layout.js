...
export const metadata = {
  title: {
    default: "অধ্যক্ষ মাওলানা শাহাদাতুজ্জামান - বগুড়া-২ আসনের প্রার্থী | জামায়াতে ইসলামী",
    template: "%s | শেখ মনজুরুল হক রাহাদ"
  },
  description: "বগুড়া-২ (সদর ও কচুয়া) আসনে জামায়াতে ইসলামী বাংলাদেশের মনোনীত প্রার্থী অধ্যক্ষ মাওলানা শাহাদাতুজ্জামান। দুর্নীতিমুক্ত, সমৃদ্ধ ও ন্যায়বিচারের বাংলাদেশ গড়ার প্রত্যয়ে আপনার সাথে।",
  keywords: [
  ...
  authors: [{ name: "অধ্যক্ষ মাওলানা শাহাদাতুজ্জামান" }],
  creator: "অধ্যক্ষ মাওলানা শাহাদাতুজ্জামান নির্বাচনী প্রচারণা টিম",
  ...
  openGraph: {
    ...
    siteName: "অধ্যক্ষ মাওলানা শাহাদাতুজ্জামান - অফিসিয়াল ক্যাম্পেইন সাইট",
    title: "অধ্যক্ষ মাওলানা শাহাদাতুজ্জামান - বগুড়া-২ আসনের প্রার্থী",
